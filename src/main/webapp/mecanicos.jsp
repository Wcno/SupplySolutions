...
<body>
    <jsp:include page="/WEB-INF/views/header.jsp">
     ...
     <%
        ...
        if (nombre != null && apellido != null && dpi != null && email != null && password != null && telefono != null && ciudad != null && id_provinciaStr != null) {
            ...
            try {
                ...
                String sql = "INSERT INTO mecanicos (id_mecanico, id_provincia, nombre, apellido, dpi, email, password, telefono, ciudad) " +
                             "VALUES (seq_mecanicos.NEXTVAL, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                if (result > 0) {
                    response.sendRedirect("mecanicos.jsp?success=true");
                } else {
                    out.println("<h3>Error al registrar el mecánico.</h3>");
                }
    ...
    <main>
      <div class="content">
       <div class="form-title"> 
          ...
          <p>Bienvenido al Taller Automotriz. Por favor, complete el formulario a continuación para registrarse como mecánico. Esto nos permitirá mantener un historial detallado de su información y las reparaciones realizadas dentro del taller, para así cumplir con todas sus bonificaciones de manera satisfactoria.</p>
        </div> 
        <%
        ...
        <div class="notification success">
          ...
          <p>Éxito! El mecánico fue registrado!</p>
          ...
          <form class="form" method="post">
            <div class="form-fields card card-body">
              ...
              <div class="input-group form-group">
                ...
                <input type="text" class="text-input" id="dpi" name="dpi" placeholder="8-1292-129" required />
              </div>
              <div class="input-group form-group">
              ...
              <div class="input-group form-group">
                ...
                <input type="text" class="text-input" id="telefono" name="telefono" required />
              </div>
              <div class="input-group form-group">
