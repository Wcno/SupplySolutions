...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
      try {
          ...
          PreparedStatement ps = conn.prepareStatement("SELECT * FROM clientes WHERE email=? AND password=?");
        ...
        <form method="post">
          ...
          <div>
            <p class="register-link">
              ¿Eres un mecánico? <a href="login-mecanico.jsp">Inicia Sesión Aquí</a>
            </p>
            <p class="register-link">
